...
@overload
def arrayfield(arg: None, **kw) -> ScalarField: ...

@overload
def arrayfield(arg: SupportsIndex, **kw) -> ArrayField[tuple[int]]: ...

@overload
def arrayfield(arg: tuple[SupportsIndex, ...], **kw) -> ArrayField[tuple[int, ...]]: ...

@overload
def arrayfield(arg: type[StructArray], **kw) -> StructField: ...
